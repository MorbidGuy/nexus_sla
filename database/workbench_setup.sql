...
CREATE USER IF NOT EXISTS 'nexus_app'@'localhost' IDENTIFIED BY 'NexusSla@2026';
CREATE USER IF NOT EXISTS 'nexus_app'@'127.0.0.1' IDENTIFIED BY 'NexusSla@2026';

ALTER USER 'nexus_app'@'localhost' IDENTIFIED BY 'NexusSla@2026';
ALTER USER 'nexus_app'@'127.0.0.1' IDENTIFIED BY 'NexusSla@2026';

GRANT ALL PRIVILEGES ON nexus_sla.* TO 'nexus_app'@'localhost';
GRANT ALL PRIVILEGES ON nexus_sla.* TO 'nexus_app'@'127.0.0.1';
FLUSH PRIVILEGES;
...
VALUES ('Administrador', 'admin@nexus.local', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin')
ON DUPLICATE KEY UPDATE email = email;

INSERT INTO users (name, email, password, role, active) VALUES
('kirashi_natsu', 'kirashi_natsu@administrator.local', '$2y$10$Zr7MtO2QDud6WvHdho7MZ.hksfWxiPE3ytYvcwQgT.nQNmmIiE06G', 'gestor', 1),
('Recursos Humanos', 'rh@nexus.local', '$2y$10$VT6o.Qs0JEGApdP9GwGj8.gfIQXHNEK4as3bC4RoP5dC69jXO/8S6', 'rh', 0),
('Usuário Operacional', 'usuario@nexus.local', '$2y$10$CTKLjqLewrUJmo6Llf847.SIqZl0I95DZ5Gos6MZQF/QiMsMC3tHG', 'usuario', 1),
