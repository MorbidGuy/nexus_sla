...
<section class="content-panel mt-4">
    <div class="panel-title">
        <h2>Fila atribuída a mim</h2>
        <a href="index.php?route=demands">Abrir fila</a>
    </div>
    <?php $canWorkDemand = true; $demands = $recentDemands; require APP_ROOT . '/app/views/demands/table.php'; ?>
</section>
