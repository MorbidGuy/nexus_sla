...
<div class="page-heading">
    ...
    <div class="d-flex gap-2">
        <a href="index.php?route=users" class="btn btn-outline-light">Usuários</a>
...
<div class="stats-grid mt-4">
    ...
    <div class="metric-card"><small>Registros</small><strong><?= (int) $storageStats['rows_count'] ?></strong></div>
    ...
    <div class="metric-card purple"><small>Usuários</small><strong><?= count($users) ?></strong></div>
</div>

<section class="content-panel mt-4">
    <div class="panel-title">
        <h2>Visualizar dashboard de usuário</h2>
    </div>
...
<?php if (!empty($selectedDashboardUser)): ?>
    <section class="content-panel mt-4">
        <div class="panel-title">
            ...
            <a href="index.php?route=dashboard" class="btn btn-sm btn-outline-light">Limpar visão</a>
        </div>
